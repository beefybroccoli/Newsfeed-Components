...
*/
  tag_span.addEventListener("click", () => {
...
Array.from(data).forEach((element) => {
  const temp_article = articleMaker(element);
  const tag_articles = document.querySelector(".articles");
  tag_articles.appendChild(temp_article);
});
